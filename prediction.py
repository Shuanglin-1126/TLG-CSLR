...
if __name__ == '__main__':
    ...
    video_path = r'/data3/SLRdata/datasets/SLDataset/phoenix2014-release/phoenix-2014-multisigner/features/fullFrame-210x260px/train/02November_2010_Tuesday_heute_default-2/1/'
    ...
    for idx_, attn_, image in zip(idx, attn, imgs[1:]):
        ...
        cv2.imwrite(f"/data/che_xiao/my_project/AdaptSign-main/output/key_pathch_attn1/0{frame_count:03d}.jpg", new_img)
        frame_count += 1
