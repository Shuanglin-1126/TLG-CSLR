...
def evaluate(prefix="./", mode="dev", evaluate_dir=None, evaluate_prefix=None,
    ...
    '''
    sclite_path = "/data/che_xiao/my_project/SCTK/bin/sclite"
    print(os.getcwd())
    ...
    if output_dir is not None:
        ...
        os.system(
            f"{sclite_path} -r {prefix}tmp.stm stm -h {prefix}out.{output_file} ctm -f 0 -o sum rsum"
        )

    sys_file = f'{prefix}out.{output_file}.sys'
